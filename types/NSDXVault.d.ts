...
interface NSDXVaultInterface extends ethers.utils.Interface {
  functions: {
    ...
    "calculateHarvestNSDXRewards()": FunctionFragment;
    "calculateTotalPendingNSDXRewards()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calculateHarvestNSDXRewards",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "calculateTotalPendingNSDXRewards",
    values?: undefined
  ): string;
...
export class NSDXVault extends BaseContract {
  ...
  functions: {
    ...
    calculateHarvestNSDXRewards(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    calculateTotalPendingNSDXRewards(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  calculateHarvestNSDXRewards(overrides?: CallOverrides): Promise<BigNumber>;
